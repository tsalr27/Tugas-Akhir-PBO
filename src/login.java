...
public class login extends javax.swing.JFrame {
    ...
    String user = "root";
    String pwd = "";
    String url = "jdbc:mysql://localhost/ta_perpus";
    ...
    void Login() {
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM login WHERE username='"+nama.getText()+"'AND password='"+password.getText()+"'");
           if (rs.next()) {
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/login_icon_176905 (1).png"))); // NOI18N
        ...
        ok.setFont(new java.awt.Font("Segoe UI Semibold", 1, 14)); // NOI18N
        ok.setText("OK");
        ...
        cancel.setFont(new java.awt.Font("Segoe UI Semibold", 1, 14)); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/rsz_1rsz_4rsz_1logo_smkn_4_malang.png"))); // NOI18N
        ...
        jLabel5.setText("SMK NEGERI 4 MALANG");
